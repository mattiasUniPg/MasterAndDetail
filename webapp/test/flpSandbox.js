		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#masterdetails2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"masterdetails2-display": {
								"semanticObject": "masterdetails2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=masterdetails2",
									"url": sap.ui.require.toUrl("masterdetails2")
								}
							}
						}
					}
